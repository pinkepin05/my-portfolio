...
import { 
  Moon, Sun, ArrowRight, ArrowLeft, X, Github, Linkedin, Mail, 
  ExternalLink, Calendar, Briefcase, 
  // Keep Lucide icons for general UI elements
} from 'lucide-react';

// Import specific technology/brand icons from react-icons/si
import { 
  SiPython, SiC, SiHtml5, SiCss3, SiCplusplus, SiReact, SiCanva, SiFigma 
} from 'react-icons/si';
  ...
  const projects = [
    {
      ...
      description: "KeSapian is a web app projects designed to help introverts connect and socialize with others. It lets users make friends and join groups based on shared interests while maintaining privacy and comfort. The app aims to create a safe and peaceful social space.",
      fullDescription: "A Group Project from Software Engineer course, The app lets users make friends and join groups based on shared interests while keeping their privacy and comfort. KeSapian aims to create a safe and peaceful social space. Built the frontend and backend of the project. Work on the Login and Register Page, Preferences page, and the User Suggestions feature.",
    ...
    },
    {
      ...
      description: "MindHaven is a web and mobile platform focused on burnout recovery through creativity and relaxation.",
      fullDescription: "Work on the UI of the Subscription Page and develop the frontend of it using React and Tailwind CSS.",
    ...
    },
    {
      ...
      fullDescription: "A project developed for my Human and Computer Interaction course, where I use Figma to design the UI, HTML,CSS, and JavaScript to build the front end of a catering service platform called Cateringz. The platform allows users to browse catering options, view menus, and orders.",
      role: "Front-End Developer",
      duration: "1 months",
  ...
  const experiences = [
    {
      ...
      description: "Designed and managed information and announcement content for the Instagram feed of the IMCB Student Activity Unit using Canva.",
      achievements: [
    ...
    },
    {
      ...
      description: "A program that facilitates students and international students to practice and enhance problem-solving skills by connecting academic theories with real-world situations.Interacted with SME stakeholders to understand the challenges they face and collaborated with the group to formulate constructive solutions.",
      achievements: [
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        ...
        darkMode ? 'bg-black border-b border-zinc-900' : 'bg-white border-b border-gray-100' 
      }`}>
        <div className="max-w-6xl mx-auto px-8 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8 md:gap-12">
            {['about', 'skills', 'certifications', 'experience', 'projects'].map((item) => (
              <button
                key={item}
      ...
      <section id="about" className="min-h-screen flex items-center px-8 pt-32 pb-20">
        <div className="max-w-4xl mx-auto w-full">
        <div className={`w-24 h-px mb-16 ${darkMode ? 'bg-white' : 'bg-black'}`} />
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-12 mb-12">
            ...
            <div className="md:w-3/5 text-center md:text-left">
              {/* Smaller Name Text */}
              <h1 className={`text-4xl md:text-5xl mb-2 leading-tight font-heading font-semibold`}>
                Kevin Jeremia
              </h1>
              {/* Smaller Title Text, adjusted to stay horizontal */}
              <h1 className="text-3xl md:text-4xl font-light tracking-tight leading-tight">
                Software Engineer <span className={`font-extralight italic ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>& Student</span>
              </h1>
            </div>

            {/* Right Column: Your Profile Picture (Square/Rectangle) */}
            <div className="md:w-2/5 flex justify-center md:justify-end">
              <img 
                src="/profile.jpg" // <--- REMEMBER TO REPLACE THIS WITH YOUR IMAGE PATH
                alt="Your Profile" 
                className="w-48 h-48 object-cover shadow-lg" // Removed rounded-full
              />
            </div>
          </div>
          
          <div className={`w-24 h-px my-12 ${darkMode ? 'bg-white' : 'bg-black'}`} />
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <p className={`text-lg font-light leading-relaxed ${
              ...
              I believe in the power of simplicity, intentional design, and clean code. My work focuses on creating intuitive interfaces that users love and experiences that make a lasting impact.
            </p>
            
            <p className={`text-lg font-light leading-relaxed ${
              darkMode ? 'text-gray-400' : 'text-gray-600'
            }`}>
              When I'm not designing or coding, you'll find me exploring new technologies, learn to build exciting, and staying inspired by art, architecture, and the world around me.
            </p>

            <p className={`text-lg font-light leading-relaxed ${
              darkMode ? 'text-gray-400' : 'text-gray-600'
            }`}>
              Open to collaboration and always ready to listen to feedback and guidance from the team to achieve the best result.
            </p>
          </div>
          
          <div className="flex gap-6 mt-16">
            {/* GitHub Link (Unchanged placeholder) */}
            <a href="https://github.com/pinkepin05" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">
              <Github size={20} />
            </a>
            {/* LinkedIn Link (UPDATED) */}
            <a href="https://www.linkedin.com/in/kevin-jeremia/" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">
              <Linkedin size={20} />
            </a>
            {/* Email Link (UPDATED) */}
            <a href="mailto:kepinjeremia@gmail.com" className="hover:opacity-60 transition-opacity">
              <Mail size={20} />
            </a>
          </div>
        </div>
      ...
      <section id="skills" className={`py-32 px-8 ${darkMode ? 'bg-zinc-950' : 'bg-gray-50'}`}>
        <div className="max-w-6xl mx-auto">
          <div className="mb-20">
            <h2 className="text-sm tracking-[0.3em] uppercase font-light mb-4">Core Competencies</h2>
            <div className={`w-12 h-px ${darkMode ? 'bg-white' : 'bg-black'}`} />
          </div>
            ...
            {skills.map((skill) => (
              <div
                ...
                className={`p-6 flex flex-col items-center justify-center text-center border rounded-lg aspect-square transition-all duration-300 hover:scale-[1.02] ${
                  darkMode ? 'bg-zinc-900 border-zinc-800 hover:border-white/50' : 'bg-white border-gray-200 hover:border-black/50'
                }`}
              >
      ...
      <section id="projects" className="py-32 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-20">
            <h2 className="text-sm tracking-[0.3em] uppercase font-light mb-4">Selected Projects</h2>
            <div className={`w-12 h-px ${darkMode ? 'bg-white' : 'bg-black'}`} />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project) => (
              ...
              >
                ...
                <p className={`text-xs tracking-widest uppercase font-light mb-2 ${
     ...
     {selectedProject && (
          ...
          <div className={`relative w-full max-w-5xl max-h-[90vh] overflow-y-auto ${
            ...
            <div className="space-y-12">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  <h4 className="text-xs tracking-widest uppercase font-light mb-2">Role</h4>
                  <p className={`font-light ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                    {selectedProject.role}
                  </p>
                </div>
                <div>
                  <h4 className="text-xs tracking-widest uppercase font-light mb-2">Duration</h4>
                  <p className={`font-light ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                    {selectedProject.duration}
                  </p>
                </div>
                <div>
                  <h4 className="text-xs tracking-widest uppercase font-light mb-2">Technologies</h4>
              ...
              <div className="space-y-6">
                ...
                */}
                ...
                <div>
                  <h4 className="text-sm font-light mb-3 tracking-wide">Outcome</h4>
                  <p className={`font-light leading-relaxed ${
                    darkMode ? 'text-gray-400' : 'text-gray-600'
                  }`}>
      ...
      <section id="experience" className={`py-32 px-8 ${darkMode ? 'bg-zinc-950' : 'bg-gray-50'}`}>
        <div className="max-w-4xl mx-auto">
          <div className="mb-20">
            <h2 className="text-sm tracking-[0.3em] uppercase font-light mb-4">Experience</h2>
            <div className={`w-12 h-px ${darkMode ? 'bg-white' : 'bg-black'}`} />
          </div>
            ...
            {experiences.map((exp, index) => (
              <div key={exp.id} className="relative">
                {index !== experiences.length - 1 && (
                  <div className={`absolute left-0 top-12 bottom-0 w-px ${
                    darkMode ? 'bg-zinc-800' : 'bg-gray-200'
                  }`} />
                )}
      ...
      <footer className={`py-12 px-8 text-center border-t ${
